...
export default function Header() {
  ...
  // All pages start with a dark hero section, so use white text when not scrolled
  ...
  // Delay close so cursor can travel from button to dropdown without gap issues
  const openDropdown = () => {
        ...
        <div className="flex h-18 items-center justify-between py-4">
          ...
          <nav className="hidden md:flex items-center gap-8">
            {navLinks.map((link) =>
              link.children ? (
                ...
                >
                  ...
                  {/* Dropdown — note: no mt, uses pt inside to bridge the gap */}
                  <div
                    className={cn(
                      "absolute top-full left-1/2 -translate-x-1/2 w-[480px] transition-all duration-200",
                      servicesOpen
                    ...
                    onMouseLeave={closeDropdown}
                  >
                    {/* Transparent bridge so cursor doesn't leave the zone */}
                    <div className="h-2 w-full" />
                    <div className="bg-bg border border-border shadow-xl rounded-md overflow-hidden">
            ...
            <Link
              href="/contacto"
              className={cn(
                "ml-2 rounded-sm px-5 py-2.5 text-sm font-medium transition-all duration-200",
                isTransparent
          ...
          <button
            className={cn(
              "flex md:hidden items-center transition-colors duration-300",
